...
public sealed class ReservedChannels
{
    ...
    [
        // Car Temps
        new() { Id = Guid.Parse("3b63f11f-224b-45d9-8b7a-12be256025a6"), Name = "CoolantTemp", IsReserved = true, Abbreviation = "COOLNT", DataType = "Temperature", BaseUnitType = "DegreeFahrenheit", Category = "Car Temps" },
        new() { Id = Guid.Parse("c6b14eae-9070-4c2a-91a9-2ce3984d30a7"), Name = "OilTemp", IsReserved = true, Abbreviation = "OILT", DataType = "Temperature", BaseUnitType = "DegreeFahrenheit", Category = "Car Temps" },
        new() { Id = Guid.Parse("e43dab22-2971-4de7-a116-b27bb3f85231"), Name = "TransTemp", IsReserved = true, Abbreviation = "TRANST", DataType = "Temperature", BaseUnitType = "DegreeFahrenheit", Category = "Car Temps" },
        new() { Id = Guid.Parse("6e704607-45ba-4449-a42e-cf52fcd86b17"), Name = "DiffTemp", IsReserved = true, Abbreviation = "DIFFT", DataType = "Temperature", BaseUnitType = "DegreeFahrenheit", Category = "Car Temps" },
        new() { Id = Guid.Parse("6349e70f-171f-4dda-900d-0e4b2a9af7f6"), Name = "AirTemp", IsReserved = true, Abbreviation = "AIRTMP", DataType = "Temperature", BaseUnitType = "DegreeFahrenheit", Category = "Car Temps" },

        // Car Pressures
        new() { Id = Guid.Parse("5d7f1ae4-3a6f-45fe-94c2-905e07af4be1"), Name = "OilPress", IsReserved = true, Abbreviation = "OILP", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Car Pressures" },
        new() { Id = Guid.Parse("a7e58908-c5d0-4438-be04-fef0ecc492a0"), Name = "FuelPress", IsReserved = true, Abbreviation = "FUELP", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Car Pressures" },
        new() { Id = Guid.Parse("eb494292-9c88-4e0e-b0d9-6dbd063b292c"), Name = "TireFLPress", IsReserved = true, Abbreviation = "TIREFL", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Car Pressures", GroupTag = "Tire Pressures" },
        new() { Id = Guid.Parse("21b8654d-2160-41e3-9bc5-2b8c5171e003"), Name = "TireFRPress", IsReserved = true, Abbreviation = "TIREFR", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Car Pressures", GroupTag = "Tire Pressures" },
        new() { Id = Guid.Parse("d75a4c25-f764-4033-add1-bc92e9c09ae4"), Name = "TireRLPress", IsReserved = true, Abbreviation = "TIRERL", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Car Pressures", GroupTag = "Tire Pressures" },
        new() { Id = Guid.Parse("ab7a81df-463e-4759-97c1-3aef2988bbbc"), Name = "TireRRPress", IsReserved = true, Abbreviation = "TIRERR", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Car Pressures", GroupTag = "Tire Pressures" },

        // Fuel
        new() { Id = Guid.Parse("a2529acf-a7c6-449f-8a85-c7d76b35dbcb"), Name = "FuelLevel", IsReserved = true, Abbreviation = "FL", DataType = "Volume", BaseUnitType = "UsGallon", Category = "Fuel" },
        ...
        // Brakes
        new() { Id = Guid.Parse("e5755aa0-3802-4729-9210-3c3e9dc8a644"), Name = "BrakePos", IsReserved = true, Abbreviation = "BRKPO", DataType = "Ratio", BaseUnitType = "Percent", Category = "Brakes" },
        new() { Id = Guid.Parse("9c4ba95c-a57d-4ede-9544-bc01246876c8"), Name = "BrakePress", IsReserved = true, Abbreviation = "BRKPRS", DataType = "Pressure", BaseUnitType = "PoundForcePerSquareInch", Category = "Brakes" },

        // PDM
        new() { Id = Guid.Parse("0913a56c-9d1c-4c6b-acf8-1963e2cb91dc"), Name = "TotalPowerCurrent", IsReserved = true, Abbreviation = "TOTPOW", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("75712356-63eb-4159-8e2f-fc19739724f0"), Name = "FuelPumpCurrent", IsReserved = true, Abbreviation = "FULPMP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("cb891a5c-169d-4d2a-a58e-b83c71e1bee5"), Name = "LiftPumpCurrent", IsReserved = true, Abbreviation = "LIFTP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("f6f3e31d-f059-449b-93b3-19c6dd2d1dca"), Name = "Abs1Current", IsReserved = true, Abbreviation = "ABS1P", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("8e320e34-13e5-4a49-8b91-3a9ba676ddb0"), Name = "Abs2Current", IsReserved = true, Abbreviation = "ABS2P", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("9c5226b5-c594-4625-abe2-fac71dea2a1b"), Name = "HeadlightsCurrent", IsReserved = true, Abbreviation = "HLDP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("b756681f-985c-44a2-b6bb-bffbc0f64c60"), Name = "TailLightsCurrent", IsReserved = true, Abbreviation = "TLLP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("b5173c8a-0eba-45a7-9032-2e4483272301"), Name = "BrakeLightsCurrent", IsReserved = true, Abbreviation = "BRKLP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("0e54d2ba-cc74-42dc-a1af-0ae0408be2aa"), Name = "DiffPumpCurrent", IsReserved = true, Abbreviation = "DIFFP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("0226c44f-2be8-4c65-984f-af61c71c31b6"), Name = "DiffFanCurrent", IsReserved = true, Abbreviation = "DIFFAN", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("7f09aafa-8d5f-454c-abb8-3ff3c841a61d"), Name = "TransFan1Current", IsReserved = true, Abbreviation = "TRNF1", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("860616c3-170e-401f-9647-26dceb466e4a"), Name = "TransFan2Current", IsReserved = true, Abbreviation = "TRNF2", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("6eb75890-d549-4329-9f5d-551ae0df5b76"), Name = "RadiatorFanCurrent", IsReserved = true, Abbreviation = "RADFAN", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("1b7c2f3b-f99d-42b7-8cd2-ecc2755133e7"), Name = "FuelCoolerCurrent", IsReserved = true, Abbreviation = "FUELC", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("ed0df2ca-77ae-4a7e-9fd6-9260f978301c"), Name = "AccusumpCurrent", IsReserved = true, Abbreviation = "ACCUSP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("5fe5e32f-0093-4242-9c35-cf5778c4b494"), Name = "CoolshirtCurrent", IsReserved = true, Abbreviation = "COOLSH", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("eccdb12a-aaa6-498a-94f5-17be598eb602"), Name = "FuelSolenoidCurrent", IsReserved = true, Abbreviation = "FUELS", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("58d20155-36a4-402d-bf4c-0cb8af5f26ac"), Name = "RainLightCurrent", IsReserved = true, Abbreviation = "RAINLP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        new() { Id = Guid.Parse("950c1ad4-afc5-41a7-aead-b8759e45abda"), Name = "RadioCurrent", IsReserved = true, Abbreviation = "RADIOP", DataType = "ElectricCurrent", BaseUnitType = "Ampere", Category = "PDM" },
        ...
        // Speed
        new() { Id = Guid.Parse("cf8698bf-3a17-4cb1-b993-c14937ad2fae"), Name = "GPSSpeed", IsReserved = true, Abbreviation = "GPSSP", DataType = "Speed", BaseUnitType = "MilePerHour", Category = "Speed" },
        ...
        new() { Id = Guid.Parse("916d4b4f-5bcf-4d9c-2a1e-4d6e8b3c5a0d"), Name = "ThrottleProxyFuelUsed", IsReserved = true, Abbreviation = "TPFUSE", DataType = "Volume", BaseUnitType = "UsGallon", Category = "Fuel", LowRange = 0, HighRange = 100, Distribution = ChannelDistribution.CarToCloud, IsDistributionLocked = true, ManagedByFeature = "throttle-consumption" },
        new() { Id = Guid.Parse("a27e5c50-6cd1-4eac-3b2f-5e7f9c4d6b0e"), Name = "ThrottleProxyRate", IsReserved = true, Abbreviation = "TPRATE", DataType = "VolumeFlow", BaseUnitType = "UsGallonPerMinute", Category = "Fuel", LowRange = 0, HighRange = 10, Distribution = ChannelDistribution.CarToCloud, IsDistributionLocked = true, ManagedByFeature = "throttle-consumption" },
        new() { Id = Guid.Parse("b38f6d61-7de2-4fbd-4c3a-6f8a1d5e7c0f"), Name = "ThrottleProxyConfidence", IsReserved = true, Abbreviation = "TPCONF", DataType = "Ratio", BaseUnitType = "Percent", Category = "Fuel", LowRange = 0, HighRange = 100, Distribution = ChannelDistribution.CarToCloud, IsDistributionLocked = true, ManagedByFeature = "throttle-consumption" },
        new() { Id = Guid.Parse("c49a7e72-8ef3-4ace-5d4b-7a9b2e6f8d10"), Name = "ThrottleProxyGridCoverage", IsReserved = true, Abbreviation = "TPGRID", DataType = "Ratio", BaseUnitType = "Percent", Category = "Fuel", LowRange = 0, HighRange = 100, Distribution = ChannelDistribution.CarToCloud, IsDistributionLocked = true, ManagedByFeature = "throttle-consumption" },
    ];
}
